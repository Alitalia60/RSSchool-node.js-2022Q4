...
export const fmMessage = async (msg) => {
  ...
  switch (msg) {
    case fmMessagesList.greeting:
      ...
      console.log('--------------------------------------------------------');
      console.log(
        // `${fmMessagesList.greeting} ${color.FgGreen}${fmOptions.currentUser}${color.Reset}`
    ...
    case fmMessagesList.goodbye:
      console.log(
        // `${fmMessagesList.goodbye}, ${color.FgGreen}${fmOptions.currentUser}${color.Reset}, goodbye!`
    ...
    case fmMessagesList.homeFolder:
      console.log(
        // `${color.FgBlue}${fmMessagesList.homeFolder}${color.FgGreen} ${fmOptions.currentDir}${color.Reset}`
