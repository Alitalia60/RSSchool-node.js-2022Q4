import * as fsOperations from '../handles/basic-operations.js';
...
export const operList = {
  ...
  cat: { executeFunc: fsOperations.cat, minArgs: 1 },
  add: { executeFunc: fsOperations.add, minArgs: 1 },
  rn: { executeFunc: fsOperations.rn, minArgs: 2 },
  cp: { executeFunc: fsOperations.cp, minArgs: 2 },
  mv: { executeFunc: fsOperations.mv, minArgs: 2 },
  rm: { executeFunc: fsOperations.remove, minArgs: 1 },
  os: { executeFunc: osOperations.osInfo, minArgs: 1, prefix: '--' },
